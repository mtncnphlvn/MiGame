...
namespace MiGame
{
    public partial class frmAdminOnayli : Form
    {
        public frmAdminOnayli()
        {
            InitializeComponent();
        }
        ...
        private void frmAdminOnayli_Load(object sender, EventArgs e)
        {
            en();
            btnIptal.Text = Localization.iptal;
            adminYonetici.AdminOyunListeleOnayli(dataGridView1);
