...
namespace MiGame
{
    public partial class frmAdminFirmalar : Form
    {
        public frmAdminFirmalar()
        {
            InitializeComponent();
        }
        ...
        public void DatagridSecim()
        {
            ...
            Firma.firmaID = Convert.ToInt32(dataGridView1.Rows[sec].Cells[0].Value.ToString());
        }
        ...
        private void frmAdminFirmalar_Load(object sender, EventArgs e)
        {
            en();
            btnSil.Text = Localization.sil;
            adminYonetici.FirmaListele(dataGridView1);
            dataGridView1.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.DisplayedCells;
        }

        private void btnSil_Click(object sender, EventArgs e)
        {
            adminYonetici.FirmaSil();
            adminYonetici.FirmaListele(dataGridView1);
        }
    }
}
